...
export class VaultController {
  ...
  */
  ...
  /**
    ...
    */
  public async syncGroup(groupname: string, keycloakGroupId: string = ''): Promise<any | undefined> {
    let group = undefined;
  ...
  /**
    ...
    */
  async createGroupInVault(groupname: string, keycloakGroupId: string): Promise<any | undefined> {
    let data = undefined;
